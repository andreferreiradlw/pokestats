...
export const kantoZones: CanvasMapperProps['areas'] = [
  ...
  },
  {
    ...
    shape: 'rect',
    coords: [160, 16, 168, 24],
    description:
      'The Indigo Plateau serves as the headquarters for the Pokémon League, where Trainers can challenge the Elite Four and Champion. It is the final destination for Trainers from Kanto and Johto, offering a Pokémon Center and shop to prepare for the ultimate battles.',
  },
  {
    id: '159',
    ...
    title: 'Victory Road',
    shape: 'rect',
    coords: [160, 32, 168, 48],
    description:
      'Victory Road is a cave that serves as the final challenge before reaching the Indigo Plateau. It is much simpler in design compared to earlier versions, with no complex puzzles or trainers, acting primarily as a passage to the Pokémon League.',
  },
  {
    id: '88',
    key: 'kanto-route-1',
  ...
  },
  {
    ...
    title: 'Route 22',
    shape: 'rect',
    coords: [168, 48, 184, 56],
    description:
      'Route 22 is a short route west of Viridian City that leads to the Pokémon League. In this version, it is largely quiet, with fewer Trainers compared to earlier games, and connects to Victory Road through the Indigo Plateau.',
  },
  {
    id: '157',
    key: 'kanto-route-23',
    title: 'Route 23',
    shape: 'rect',
    coords: [160, 24, 168, 32],
    description:
      "Route 23 is a short, straightforward path leading to the Indigo Plateau. It no longer requires passing through a badge checkpoint and serves as a simple route connecting Victory Road to the Pokémon League's final destination.",
  },
  {
    id: '103',
    key: 'kanto-route-24',
  ...
  },
  {
    ...
    title: 'Route 26',
    shape: 'rect',
    coords: [136, 80, 160, 88],
    description:
      'Route 26 is a long, scenic route in western Kanto that connects Victory Road to the south with the Pokémon League at Indigo Plateau. It features a variety of Trainers and serves as a final challenge before entering the Elite Four. There is also a resting house for Trainers to heal their Pokémon',
  },
  {
    id: '106',
    key: 'kanto-route-27',
    title: 'Route 27',
    shape: 'rect',
    coords: [168, 56, 160, 88],
    description:
      'Route 27 is a route in eastern Kanto that connects Tohjo Falls to Route 26. It serves as the entrance to Kanto from Johto and features a mix of land and water paths. Trainers traveling this route are nearing the end of their journey to the Pokémon League.',
  },
  {
    id: '107',
    key: 'kanto-route-28',
    title: 'Route 28',
    shape: 'rect',
    coords: [144, 48, 160, 56],
    description:
      'Route 28 is a rugged, mountainous path in western Kanto that leads to Silver Cave. It is a remote route with tall grass and few trainers, offering a quiet approach to the challenging cave ahead.',
  },
  {
    id: '82',
    key: 'mt-silver',
    title: 'Route',
    shape: 'rect',
    coords: [144, 48, 136, 56],
    description:
      'Mt. Silver is a dangerous, towering mountain located on the western edge of Johto. It is known for its strong wild Pokémon and serves as the ultimate challenge for skilled Trainers. At the summit, the most powerful Trainer awaits, making it a final test of strength.',
  },
  {
    id: '140',
    key: 'tohjo-falls',
    title: 'Tohjo Falls',
    shape: 'rect',
    coords: [152, 75, 144, 83],
    description:
      "Tohjo Falls is a set of waterfalls located between Johto and Kanto. Trainers must traverse these falls to cross from Johto into Kanto. It's a key passage on the journey toward the Pokémon League, requiring the use of the Waterfall move to navigate.",
  },
  {
    id: '84',
    key: 'new-bark-town',
    title: 'New Bark Town',
    shape: 'rect',
    coords: [136, 80, 128, 88],
    description:
      "New Bark Town is a small, quiet town in Johto and the starting point for many Trainers' journeys. It is home to Professor Elm's Lab, where new Trainers receive their first Pokémon. Located on the eastern edge of Johto, it borders Route 29 and is the gateway to both Kanto and Johto.",
  },
  {
    id: '108',
    key: 'johto-route-29',
    ...
    coords: [128, 80, 96, 88],
    description:
      'Route 29 is a peaceful route connecting New Bark Town to Cherrygrove City. It features grassy areas for wild Pokémon encounters and is the first route Trainers traverse at the beginning of their journey. The route is dotted with ledges and small patches of trees, offering a gentle introduction to the Johto region.',
  },
  {
    id: '110',
    key: 'johto-route-30',
    ...
    coords: [96, 80, 88, 48],
    description:
      'Route 30 is a forested path in northern Johto that connects Cherrygrove City to Route 31. It features small houses, including one where Mr. Pokémon resides, and is home to various low-level wild Pokémon, making it an essential early training ground for new Trainers.',
  },
  {
    id: '111',
    key: 'johto-route-31',
    ...
    coords: [96, 48, 80, 40],
    description:
      'Route 31 is a short route in northern Johto that connects Route 30 to Violet City. It features dark patches of tall grass with wild Pokémon and an entrance to Dark Cave. It serves as a key passage for Trainers heading toward their first Gym challenge.',
  },
  {
    id: '104',
    key: 'johto-',
  ...
  },
  {
    ...
    title: 'Route 45',
    shape: 'rect',
    coords: [128, 64, 120, 32],
    description:
      'Route 45 is a mountainous, winding route that connects Blackthorn City to Route 46. It features steep ledges, making it a one-way route in certain areas, and is filled with tall grass and rocky terrain where wild Pokémon can be encountered. This route is known for its multiple branching paths, offering different experiences depending on which direction is taken.',
  },
  {
    id: '127',
    key: 'johto-route-46',
    title: 'Route 46',
    shape: 'rect',
    coords: [120, 80, 112, 56],
    description:
      'Route 46 is a mountainous route located north of Route 29, offering an early connection to higher-altitude areas of Johto. Although the route is accessible early in the game, players can only explore the lower section until later. The rocky terrain is home to several wild Pokémon, making it a popular spot for Trainers seeking early battles.',
  },
  {
    id: '72',
    key: 'dark-cave',
    title: 'Dark Cave',
    shape: 'rect',
    coords: [116, 60, 108, 52],
    description:
      'Dark Cave is a sprawling, pitch-black cave located between Routes 31 and 45. It requires the use of the HM move Flash to navigate effectively. Inside, Trainers encounter various wild Pokémon and rocky terrain. The cave has multiple entrances, allowing access from different points in Johto, but full exploration requires both Flash and Surf.',
  },
  {
    id: '72',
    key: 'dark-cave',
  ...
  {
    id: '69',
    key: 'cherrygrove-city',
    title: 'Cherrygrove City',
    shape: 'rect',
    coords: [96, 87, 88, 80],
    description:
      'Cherrygrove City is a small, coastal town located west of New Bark Town. It serves as an early stop for Trainers, offering a Poké Mart, a Pokémon Center, and a guide who provides helpful tips. The city is also a gateway to Route 30, leading further into the Johto region.',
  },
  {
    id: '153',
    key: 'violet-city',
    ...
    coords: [72, 48, 80, 40],
    description:
      'Violet City is a historic city in Johto, home to the first Gym, led by Falkner, who specializes in Flying-type Pokémon. The city features the Sprout Tower, where Trainers battle monks and gain wisdom, and the Pokémon Academy, offering valuable battle tips. Violet City marks an important early milestone for Trainers on their journey.',
  },
  {
    id: '138',
    key: 'sprout-tower',
    ...
    coords: [72, 43, 80, 35],
    description:
      'Sprout Tower is a tall, wooden structure in Violet City, known for its swaying central pillar and its connection to Bellsprout. Inside, Trainers can battle sages who raise Bellsprout. The tower serves as a place for reflection and training for those seeking spiritual growth and Pokémon strength.',
  },
  {
    id: '104',
    key: 'johto-',
